...
let div1p = titledivchild(
  ...
  "id",
  "description",
  " Fill the answer and choose the favourite Food items of Minimum Two:-"
);
...
let food_label2 = fooditemslabel("label", "for", "food", "Tacos");
let food_label3 = fooditemslabel("label", "for", "food", "Som tam");
...
let th1 = tableheader("th", "scope", "col", "FIRST NAME");
let th2 = tableheader("th", "scope", "col", "LAST NAME");
...
let th8 = tableheader("th", "scope", "col", "FOOD ITEMS");
